			...
			for(var i=0;i<blockedusers.length;i++){
				...
				removebtn.onclick=function(btn){
					...
					for(var i=shoutboxcontainer.children.length-2;i>-1;i-=2){
						...
						if(user.children[0].textContent===btn.target.user){
							shoutboxcontainer.children[i+1].style.visibility="visible";
							shoutboxcontainer.children[i].style.visibility="visible";
							shoutboxcontainer.children[i+1].style.height="auto";
							shoutboxcontainer.children[i].style.height="auto";
							shoutboxcontainer.children[i+1].style.padding="2px 2px 2px 10px";
							shoutboxcontainer.children[i].style.padding="3px 0";
						}
					}
		...
		if(L.g("blocked_users",new Array(0)).f(userBlocking)===-1){
			...
			for(var i=shoutboxcontainer.children.length-2;i>-1;i-=2){
				if(shoutboxcontainer.children[i].children[0].innerText===userBlocking){
					shoutboxcontainer.children[i+1].style.visibility="hidden";
					shoutboxcontainer.children[i].style.visibility="hidden";
					shoutboxcontainer.children[i+1].style.height="0px";
					shoutboxcontainer.children[i].style.height="0px";
					shoutboxcontainer.children[i+1].style.padding="0px";
					shoutboxcontainer.children[i].style.padding="0px";
				}
			}
			remBut.enabled=true;
			remBut.buttoncontent.remove();
		}
